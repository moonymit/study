...
public class ChibiCharacter extends GameObject {
    ...
    public ChibiCharacter(GameSurface gameSurface, Bitmap image, int x, int y) {
        ...
        this.topToBottoms = new Bitmap[COL_COUNT]; // 3
        this.rightToLefts = new Bitmap[COL_COUNT]; // 3
        this.leftToRights = new Bitmap[COL_COUNT]; // 3
        this.bottomToTops = new Bitmap[COL_COUNT]; // 3
